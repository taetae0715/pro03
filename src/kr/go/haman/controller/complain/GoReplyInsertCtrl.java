...
@WebServlet("/GoReplyInsert.do")
public class GoReplyInsertCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/sub1/complain/replyInsert.jsp");
