...
.item3 {background-color:rgb(0,154,218);color:white}
...
td{vertical-align:middle!important;width:20%!important}
</style>
</head>
<body>
...
<div class="main_wrap">
	...
	<table class="table is-bordered" style="width:100%;text-align:center;">
		...
		<tr>
			<td rowspan="6" style="background-color:rgb(230,243,255);">부산T/R</td>
			<td>9:20</td>
			<td rowspan="6" style="background-color:rgb(230,243,255);">함안T/R</td>
			<td>11:10</td>
			<td rowspan="6" style="background-color:rgb(230,243,255);">동일고속</td>
		</tr>
		<tr>
			<td>11:30 (금, 토, 일, 월)</td>
			<td>12:20 (금, 토, 일, 월)</td>
