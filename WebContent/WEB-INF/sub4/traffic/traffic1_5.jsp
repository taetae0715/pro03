...
<head>
<meta charset="UTF-8">
<title>시내/시외버스 - 김해,장유(고속도)함안</title>
<style>
img {border:0;}
...
.item5 {background-color:rgb(0,154,218);color:white}
...
<div class="main_wrap">
	...
	<table class="table is-bordered" style="width:100%;text-align:center;">
		<tr style="background-color:rgb(230,243,255);text-align:center;font-weight:600;">
			<td>출발</td>
			<td>출발시간</td>
			<td style="width:30%">경유지</td>
			<td>도착지</td>
			<td>도착시간</td>
			<td>비고</td>
		</tr>
		<tr style="height:100px">
			<td style="background-color:rgb(230,243,255);">진주 T/R</td>
			<td ></td>
			<td >전면중단</td>
			<td  style="background-color:rgb(230,243,255);">함안 T/R</td>
			<td ></td>
			<td></td>
		</tr>
		<tr style="height:100px"> 
